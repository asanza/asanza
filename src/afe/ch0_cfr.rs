#[doc = "Reader of register CH0_CFR"]
pub type R = crate::R<u32, super::CH0_CFR>;
#[doc = "Writer for register CH0_CFR"]
pub type W = crate::W<u32, super::CH0_CFR>;
#[doc = "Register CH0_CFR `reset()`'s with value 0x0008_0000"]
impl crate::ResetValue for super::CH0_CFR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "AFE Channel0 bypass mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BYP_MODE_A {
    #[doc = "0: Normal mode"]
    _0 = 0,
    #[doc = "1: Bypass mode where ADC and PGA of channel0 are disabled."]
    _1 = 1,
}
...
impl<'a> BYP_MODE_W<'a> {
    ...
    #[doc = "Bypass mode where ADC and PGA of channel0 are disabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 17 - AFE Channel0 bypass mode"]
    #[inline(always)]
