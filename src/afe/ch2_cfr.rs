#[doc = "Reader of register CH2_CFR"]
pub type R = crate::R<u32, super::CH2_CFR>;
#[doc = "Writer for register CH2_CFR"]
pub type W = crate::W<u32, super::CH2_CFR>;
#[doc = "Register CH2_CFR `reset()`'s with value 0x0008_0000"]
impl crate::ResetValue for super::CH2_CFR {
    type Type = u32;
    #[inline(always)]
...
pub enum SD_MOD_EN_A {
    #[doc = "0: SD ADC3 is disabled"]
    _0 = 0,
    #[doc = "1: SD ADC3 is enabled"]
    _1 = 1,
}
...
impl<'a> SD_MOD_EN_W<'a> {
    ...
    #[doc = "SD ADC3 is disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(SD_MOD_EN_A::_0)
    }
    #[doc = "SD ADC3 is enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "AFE Channel2 bypass mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BYP_MODE_A {
    #[doc = "0: Normal mode"]
    _0 = 0,
    #[doc = "1: Bypass mode where ADC and PGA of channel2 are disabled."]
    _1 = 1,
}
...
impl<'a> BYP_MODE_W<'a> {
    ...
    #[doc = "Bypass mode where ADC and PGA of channel2 are disabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "This field selects the analog gain applied to the input signal.\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
...
#[doc = "It enables the PGA gain stage.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PGA_EN_A {
    #[doc = "0: PGA disabled"]
    _0 = 0,
...
impl R {
    ...
    #[doc = "Bit 17 - AFE Channel2 bypass mode"]
    #[inline(always)]
    pub fn byp_mode(&self) -> BYP_MODE_R {
        BYP_MODE_R::new(((self.bits >> 17) & 0x01) != 0)
    }
    #[doc = "Bits 19:21 - This field selects the analog gain applied to the input signal."]
    #[inline(always)]
    pub fn pga_gain_sel(&self) -> PGA_GAIN_SEL_R {
        PGA_GAIN_SEL_R::new(((self.bits >> 19) & 0x07) as u8)
    }
    #[doc = "Bit 24 - It enables the PGA gain stage."]
    #[inline(always)]
