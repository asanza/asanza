...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BGEN_A {
    #[doc = "0: Bandgap voltage reference is disabled in VLPx , and VLLSx modes."]
    _0 = 0,
    #[doc = "1: Bandgap voltage reference is enabled in VLPx , and VLLSx modes."]
    _1 = 1,
}
...
impl<'a> BGEN_W<'a> {
    ...
    #[doc = "Bandgap voltage reference is disabled in VLPx , and VLLSx modes."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(BGEN_A::_0)
    }
    #[doc = "Bandgap voltage reference is enabled in VLPx , and VLLSx modes."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
