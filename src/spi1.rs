...
#[doc = "SPI data register high"]
pub mod dh;
#[doc = "SPI clear interrupt register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ci](ci) module"]
pub type CI = crate::Reg<u8, _CI>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CI;
#[doc = "`read()` method returns [ci::R](ci::R) reader structure"]
impl crate::Readable for CI {}
#[doc = "`write(|w| ..)` method takes [ci::W](ci::W) writer structure"]
impl crate::Writable for CI {}
#[doc = "SPI clear interrupt register"]
pub mod ci;
