#[doc = "Reader of register MH"]
pub type R = crate::R<u8, super::MH>;
#[doc = "Writer for register MH"]
pub type W = crate::W<u8, super::MH>;
#[doc = "Register MH `reset()`'s with value 0"]
impl crate::ResetValue for super::MH {
    type Type = u8;
    #[inline(always)]
