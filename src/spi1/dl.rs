#[doc = "Reader of register DL"]
pub type R = crate::R<u8, super::DL>;
#[doc = "Writer for register DL"]
pub type W = crate::W<u8, super::DL>;
#[doc = "Register DL `reset()`'s with value 0"]
impl crate::ResetValue for super::DL {
    type Type = u8;
    #[inline(always)]
