...
#[doc = "User Mode, Nonsecure Mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum UMNSM_A {
    #[doc = "0: Channel attributes are set to the current mode."]
    _00 = 0,
    #[doc = "1: If the current mode is privileged and secure, then attributes are set to {privileged, secure}. Otherwise, writing this value terminates in an error."]
    _01 = 1,
    #[doc = "2: If the current mode is privileged and secure or if the current mode is user and secure, then attributes are set to {user, secure}. Otherwise, writing this value terminates in an error."]
    _10 = 2,
    #[doc = "3: If the current mode is privileged and secure, user and secure, or user and nonsecure, then attributes are set to {user, nonsecure}."]
    _11 = 3,
}
impl From<UMNSM_A> for u8 {
    #[inline(always)]
    fn from(variant: UMNSM_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `UMNSM`"]
pub type UMNSM_R = crate::R<u8, UMNSM_A>;
impl UMNSM_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> UMNSM_A {
        match self.bits {
            0 => UMNSM_A::_00,
            1 => UMNSM_A::_01,
            2 => UMNSM_A::_10,
...
#[doc = "Write proxy for field `UMNSM`"]
pub struct UMNSM_W<'a> {
    w: &'a mut W,
}
impl<'a> UMNSM_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: UMNSM_A) -> &'a mut W {
        {
            self.bits(variant.into())
        }
    }
    #[doc = "Channel attributes are set to the current mode."]
    #[inline(always)]
    pub fn _00(self) -> &'a mut W {
        self.variant(UMNSM_A::_00)
    }
    #[doc = "If the current mode is privileged and secure, then attributes are set to {privileged, secure}. Otherwise, writing this value terminates in an error."]
    #[inline(always)]
    pub fn _01(self) -> &'a mut W {
        self.variant(UMNSM_A::_01)
    }
    #[doc = "If the current mode is privileged and secure or if the current mode is user and secure, then attributes are set to {user, secure}. Otherwise, writing this value terminates in an error."]
    #[inline(always)]
    pub fn _10(self) -> &'a mut W {
        self.variant(UMNSM_A::_10)
    }
    #[doc = "If the current mode is privileged and secure, user and secure, or user and nonsecure, then attributes are set to {user, nonsecure}."]
    #[inline(always)]
    pub fn _11(self) -> &'a mut W {
        self.variant(UMNSM_A::_11)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
...
#[doc = "Reader of field `CHACR`"]
pub type CHACR_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `CHACR`"]
pub struct CHACR_W<'a> {
    w: &'a mut W,
}
impl<'a> CHACR_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
impl R {
    ...
    #[doc = "Bits 24:25 - User Mode, Nonsecure Mode"]
    #[inline(always)]
    pub fn umnsm(&self) -> UMNSM_R {
        UMNSM_R::new(((self.bits >> 24) & 0x03) as u8)
    }
    #[doc = "Bits 26:27 - Channel Access Control"]
    #[inline(always)]
    pub fn chacr(&self) -> CHACR_R {
        CHACR_R::new(((self.bits >> 26) & 0x03) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 24:25 - User Mode, Nonsecure Mode"]
    #[inline(always)]
    pub fn umnsm(&mut self) -> UMNSM_W {
        UMNSM_W { w: self }
    }
    #[doc = "Bits 26:27 - Channel Access Control"]
    #[inline(always)]
    pub fn chacr(&mut self) -> CHACR_W {
        CHACR_W { w: self }
    }
    #[doc = "Bit 28 - Auto-align"]
    #[inline(always)]
