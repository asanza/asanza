...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ROB_A {
    #[doc = "0: Writes to the ACB are allowed."]
    _0 = 0,
    #[doc = "1: Writes to the ACB are ignored."]
    _1 = 1,
}
...
impl<'a> ROB_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: ROB_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    #[doc = "Writes to the ACB are allowed."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(ROB_A::_0)
    }
    #[doc = "Writes to the ACB are ignored."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(ROB_A::_1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Attribute Check Byte"]
    #[inline(always)]
    pub fn acb(&self) -> ACB_R {
        ACB_R::new((self.bits & 0x07) as u8)
    }
    #[doc = "Bit 7 - Read-Only Byte"]
    #[inline(always)]
