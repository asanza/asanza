#[doc = "Writer for register CAU_LDR_CASR"]
pub type W = crate::W<u32, super::CAU_LDR_CASR>;
#[doc = "Register CAU_LDR_CASR `reset()`'s with value 0x2000_0000"]
impl crate::ResetValue for super::CAU_LDR_CASR {
    type Type = u32;
    #[inline(always)]
