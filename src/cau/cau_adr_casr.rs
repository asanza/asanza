#[doc = "Writer for register CAU_ADR_CASR"]
pub type W = crate::W<u32, super::CAU_ADR_CASR>;
#[doc = "Register CAU_ADR_CASR `reset()`'s with value 0x2000_0000"]
impl crate::ResetValue for super::CAU_ADR_CASR {
    type Type = u32;
    #[inline(always)]
