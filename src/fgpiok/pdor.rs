...
pub type R = crate::R<u8, super::PDOR>;
#[doc = "Writer for register PDOR"]
pub type W = crate::W<u8, super::PDOR>;
...
pub type PDO_R = crate::R<u8, PDO_A>;
impl PDO_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, PDO_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(PDO_A::_0),
            1 => Val(PDO_A::_1),
...
impl R {
    #[doc = "Bits 0:7 - Port Data Output"]
    #[inline(always)]
    pub fn pdo(&self) -> PDO_R {
        PDO_R::new((self.bits & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - Port Data Output"]
