#[doc = "Reader of register VREFH_SC"]
pub type R = crate::R<u8, super::VREFH_SC>;
#[doc = "Writer for register VREFH_SC"]
pub type W = crate::W<u8, super::VREFH_SC>;
#[doc = "Register VREFH_SC `reset()`'s with value 0"]
impl crate::ResetValue for super::VREFH_SC {
    type Type = u8;
    #[inline(always)]
