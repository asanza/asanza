...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum OPE_A {
    #[doc = "0: CMPO is not available on the associated CMPO output pin."]
    _0 = 0,
    #[doc = "1: CMPO is available on the associated CMPO output pin."]
    _1 = 1,
}
...
impl<'a> OPE_W<'a> {
    ...
    #[doc = "CMPO is not available on the associated CMPO output pin."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(OPE_A::_0)
    }
    #[doc = "CMPO is available on the associated CMPO output pin."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
