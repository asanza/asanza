#[doc = "Reader of register ML"]
pub type R = crate::R<u8, super::ML>;
#[doc = "Writer for register ML"]
pub type W = crate::W<u8, super::ML>;
#[doc = "Register ML `reset()`'s with value 0"]
impl crate::ResetValue for super::ML {
    type Type = u8;
    #[inline(always)]
