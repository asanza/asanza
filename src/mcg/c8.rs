...
#[doc = "Loss of Coarse Lock Interrrupt Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum COARSE_LOLIE_A {
    #[doc = "0: No interrupt request is generated on coarse loss of lock."]
    _0 = 0,
    #[doc = "1: Generate an interrupt request on coarse loss of lock."]
    _1 = 1,
}
impl From<COARSE_LOLIE_A> for bool {
    #[inline(always)]
    fn from(variant: COARSE_LOLIE_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `COARSE_LOLIE`"]
pub type COARSE_LOLIE_R = crate::R<bool, COARSE_LOLIE_A>;
impl COARSE_LOLIE_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> COARSE_LOLIE_A {
        match self.bits {
            false => COARSE_LOLIE_A::_0,
            true => COARSE_LOLIE_A::_1,
        }
    }
    #[doc = "Checks if the value of the field is `_0`"]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == COARSE_LOLIE_A::_0
    }
    #[doc = "Checks if the value of the field is `_1`"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == COARSE_LOLIE_A::_1
    }
}
#[doc = "Write proxy for field `COARSE_LOLIE`"]
pub struct COARSE_LOLIE_W<'a> {
    w: &'a mut W,
}
impl<'a> COARSE_LOLIE_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: COARSE_LOLIE_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    #[doc = "No interrupt request is generated on coarse loss of lock."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(COARSE_LOLIE_A::_0)
    }
    #[doc = "Generate an interrupt request on coarse loss of lock."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(COARSE_LOLIE_A::_1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 4 - Loss of Coarse Lock Interrrupt Enable"]
    #[inline(always)]
    pub fn coarse_lolie(&self) -> COARSE_LOLIE_R {
        COARSE_LOLIE_R::new(((self.bits >> 4) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 4 - Loss of Coarse Lock Interrrupt Enable"]
    #[inline(always)]
    pub fn coarse_lolie(&mut self) -> COARSE_LOLIE_W {
        COARSE_LOLIE_W { w: self }
    }
    #[doc = "Bit 5 - Clock Monitor Enable1"]
    #[inline(always)]
