...
#[doc = "Register C6 `reset()`'s with value 0x08"]
...
#[doc = "Reader of field `CHGPMP_BIAS`"]
pub type CHGPMP_BIAS_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `CHGPMP_BIAS`"]
pub struct CHGPMP_BIAS_W<'a> {
    w: &'a mut W,
}
impl<'a> CHGPMP_BIAS_W<'a> {
...
pub enum PLLS_A {
    ...
    _0 = 0,
    #[doc = "1: PLL is selected (PLL reference clock must be in the range of 31.25-39.0625 KHz prior to setting the PLLS bit)."]
    _1 = 1,
}
...
impl<'a> PLLS_W<'a> {
    ...
    #[doc = "PLL is selected (PLL reference clock must be in the range of 31.25-39.0625 KHz prior to setting the PLLS bit)."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    #[doc = "Bits 0:4 - Directly controls the PLL Charge Pump Current. Appropiate selection of this value is imperative to ensure stable operation of the PLL closed loop system. The default value for this field is set to 5'b01000 out of reset which generates a nominal 750 nA charge pump current (lcp)."]
    #[inline(always)]
    pub fn chgpmp_bias(&self) -> CHGPMP_BIAS_R {
        CHGPMP_BIAS_R::new((self.bits & 0x1f) as u8)
    }
...
impl W {
    #[doc = "Bits 0:4 - Directly controls the PLL Charge Pump Current. Appropiate selection of this value is imperative to ensure stable operation of the PLL closed loop system. The default value for this field is set to 5'b01000 out of reset which generates a nominal 750 nA charge pump current (lcp)."]
    #[inline(always)]
    pub fn chgpmp_bias(&mut self) -> CHGPMP_BIAS_W {
        CHGPMP_BIAS_W { w: self }
    }
    #[doc = "Bit 5 - Clock Monitor Enable"]
    #[inline(always)]
